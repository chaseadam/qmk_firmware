...
// swapping k36 and k35 because willy's keyboard wired the two center keys backwards
// Note: I only swapped the two-dimensional array so that the "arguments" are normal, but mapped to reversed locations
